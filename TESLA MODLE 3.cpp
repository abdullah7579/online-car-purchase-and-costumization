#include<iostream>
using namespace std;
//range=range, tspeed= top speed in mile, hmile=time for half mile ,t=3
float v,trange=236,ttspeed=140,thmile=5.3,awdrange=353,awdtspeed=145,awdhmile=4.2,Prange=315,Ptspeed=162,Phmile=3.1;
...
float vprice1=28490,vprice2=35490,vprice3=40490,paintprice=500,aprice=2500,sdprice=2500,srprice=1500,hsprice=2000,hstprice=1000,swprice=100,tkprice=100,wcprice=1500,mcprice=1500,apprice=500,kfprice=700,spprice=5000;
...
void vdetail()
{
	cout<<"Which varient do you want(For Model 3 press 1, For Model 3 AWD press 2,For Modle 3 performance press 3): "<<endl;
	cin>>v;
	...
	if(v==1)
	{
		...
		v3 = ttspeed;
		v4 = thmile;
		cout<<"You selected Model 3 which will have: "<<endl<<trange<<"mile range, "<<endl<<ttspeed<<"mileperhour top speed, "<<endl<<"Will require "<<thmile<<"seconds to reach half mile"<<endl;
		tpr=tpr+vprice1;
		cvprice=vprice1;
		cout<<"Price of your Model 3 is: "<<tpr<<endl;
	}
	else if(v==2)
	{	v1 = "Model 3 AWD";
		v2 = awdrange;
		v3 = awdtspeed;
		v4 = awdhmile;
		cout<<"You selected Model 3 AWD which will have: "<<endl<<awdrange<<"mile range, "<<endl<<awdtspeed<<"mileperhour top speed, "<<endl<<"Will require "<<awdhmile<<"seconds to reach half mile"<<endl;
		tpr=tpr+vprice2;
		cvprice=vprice2;
		cout<<"Price of your Model 3 AWD is: "<<tpr<<endl;}
	else
	{
		v1 = "Model 3 Performance";
		v2 = Prange;
		v3 = Ptspeed;
		v4 = Phmile;
		cout<<"You selected Model 3 Performance which will have: "<<endl<<Prange<<"mile range, "<<endl<<Ptspeed<<"mileperhour top speed, "<<endl<<"Will require "<<Phmile<<"seconds to reach half mile"<<endl;
		tpr=tpr+vprice3;
		cvprice=vprice3;
		cout<<"Price of your Model 3 performance is: "<<tpr<<endl;
	}
}
void paint()
{
